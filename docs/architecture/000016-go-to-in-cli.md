...
- [CLI GoTo Section](../../compatibility-tests/goto-section/cli/basic.md)
- [CLI Call and Return](../../compatibility-tests/goto-section-and-back/cli/basic.md)
- [CLI GoTo END](../../compatibility-tests/goto-end/cli/basic.md)
- [CLI GoTo START](../../compatibility-tests/goto-start/cli/basic.md)
- [CLI GoTo RESTART](../../compatibility-tests/goto-restart/cli/basic.md)
- [Mix Script and CLI GoTos](../../compatibility-tests/goto-section/cli/mix-script-and-cli.md)
- [CLI GoTo with Relative Child Path](../../compatibility-tests/goto-section/cli/relative-child.md)
- [CLI GoTo with Parent Navigation](../../compatibility-tests/goto-section/cli/parent-navigation.md)
- [CLI GoTo Current Section](../../compatibility-tests/goto-section/cli/current-section.md)
- [CLI GoTo with Absolute Path](../../compatibility-tests/goto-section/cli/absolute-path.md)
- [CLI GoTo During Call Stack](../../compatibility-tests/goto-section-and-back/cli/goto-during-call-stack.md)
- [CLI Call During Call Stack](../../compatibility-tests/goto-section-and-back/cli/call-during-call-stack.md)
- [Multiple CLI GoTos in Sequence](../../compatibility-tests/goto-section/cli/multiple-gotos-sequence.md)
- [CLI GoTo After Script GoTo](../../compatibility-tests/goto-section/cli/after-script-goto.md)
- [CLI Error: Section Not Found](../../compatibility-tests/goto-section/cli/error-section-not-found.md)
- [CLI Error: Navigate Above Root](../../compatibility-tests/goto-section/cli/error-navigate-above-root.md)
- [CLI Error: Malformed GoTo Empty](../../compatibility-tests/goto-section/cli/error-malformed-empty.md)
- [CLI Error: Trailing Backslash](../../compatibility-tests/goto-section/cli/error-trailing-backslash.md)
- [CLI Error: No Space After Arrow](../../compatibility-tests/goto-section/cli/error-no-space-after-arrow.md)
