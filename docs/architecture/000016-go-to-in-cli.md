...
- [CLI GoTo Section](../../compatibility-tests/00000000200-cli-goto-section.md)
- [CLI Call and Return](../../compatibility-tests/00000000201-cli-call-and-return.md)
- [CLI GoTo END](../../compatibility-tests/00000000202-cli-goto-end.md)
- [CLI GoTo START](../../compatibility-tests/00000000203-cli-goto-start.md)
- [CLI GoTo RESTART](../../compatibility-tests/00000000204-cli-goto-restart.md)
- [Mix Script and CLI GoTos](../../compatibility-tests/00000000205-cli-mix-script-and-cli-gotos.md)
- [CLI GoTo with Relative Child Path](../../compatibility-tests/00000000206-cli-goto-relative-child.md)
- [CLI GoTo with Parent Navigation](../../compatibility-tests/00000000207-cli-goto-parent-navigation.md)
- [CLI GoTo Current Section](../../compatibility-tests/00000000208-cli-goto-current-section.md)
- [CLI GoTo with Absolute Path](../../compatibility-tests/00000000209-cli-goto-absolute-path.md)
- [CLI GoTo During Call Stack](../../compatibility-tests/00000000210-cli-goto-during-call-stack.md)
- [CLI Call During Call Stack](../../compatibility-tests/00000000211-cli-call-during-call-stack.md)
- [Multiple CLI GoTos in Sequence](../../compatibility-tests/00000000212-cli-multiple-gotos-sequence.md)
- [CLI GoTo After Script GoTo](../../compatibility-tests/00000000213-cli-goto-after-script-goto.md)
- [CLI Error: Section Not Found](../../compatibility-tests/00000000214-cli-error-section-not-found.md)
- [CLI Error: Navigate Above Root](../../compatibility-tests/00000000215-cli-error-navigate-above-root.md)
- [CLI Error: Malformed GoTo Empty](../../compatibility-tests/00000000216-cli-error-malformed-empty.md)
- [CLI Error: Trailing Backslash](../../compatibility-tests/00000000217-cli-error-trailing-backslash.md)
- [CLI Error: No Space After Arrow](../../compatibility-tests/00000000218-cli-error-no-space-after-arrow.md)
