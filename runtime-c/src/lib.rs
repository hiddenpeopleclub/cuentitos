...
#[no_mangle]
pub extern "C" fn cuentitos_set_float_resource(id: RuntimeId, resource: Cstring, value: f32) -> bool {
  return set_resource(id, resource, value);
}

#[no_mangle]
pub extern "C" fn cuentitos_set_bool_resource(id: RuntimeId, resource: Cstring, value: bool) -> bool {
  return set_resource(id, resource, value);
}

#[no_mangle]
pub extern  "C" fn cuentitos_get_int_resource(id: RuntimeId, resource: Cstring, value: *mut i32) -> bool 
{
  return get_resource(id, resource, value);
}

#[no_mangle]
pub extern  "C" fn cuentitos_get_float_resource(id: RuntimeId, resource: Cstring, value: *mut f32) -> bool 
{
  return get_resource(id, resource, value);
}

#[no_mangle]
pub extern  "C" fn cuentitos_get_bool_resource(id: RuntimeId, resource: Cstring, value: *mut bool) -> bool 
{
  return get_resource(id, resource, value);
}
...
#[no_mangle]
pub extern "C" fn cuentitos_get_reputation(id: RuntimeId, reputation: Cstring, value: *mut i32) -> bool {
    if invalid_runtime(id) { return false; }
    if reputation.is_null() { return false; }
...
#[no_mangle]
pub extern "C" fn cuentitos_get_decision(id: RuntimeId, decision: Cstring, value: *mut bool) -> bool {
    if invalid_runtime(id) { return false; }
    if decision.is_null() { return false; }
    if value.is_null() { return false; }
...
#[no_mangle]
pub extern "C" fn cuentitos_current_modifiers(id: usize,buffer: *mut u8, length: *mut usize) -> bool {
  if buffer.is_null() { return false; }
  if length.is_null() { return false; }
  if invalid_runtime(id) { return false; }
