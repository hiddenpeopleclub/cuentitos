...
#[derive(Debug, Clone)]
pub enum ParseError {
    UnexpectedToken { file: Option<PathBuf>, line: usize },
    UnexpectedEndOfFile { file: Option<PathBuf>, line: usize },
    InvalidIndentation { message: String, file: Option<PathBuf>, line: usize },
}
...
impl fmt::Display for ParseError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            ParseError::InvalidIndentation { message, file: _, line } => {
...
impl Parser {
    ...
    where A: AsRef<str>
    {
        ...
        for line in script.lines() {
            ...
            let line = line_parser::Line { text: content.trim() };
...
mod test {
    ...
    fn test_invalid_indentation_with_file() {
        ...
        match parser.parse(script) {
            Err(ParseError::InvalidIndentation { message: _, file: Some(path), line: 2 }) => {
