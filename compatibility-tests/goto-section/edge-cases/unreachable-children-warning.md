...
## Result
```result
unreachable-children-warning.cuentitos:4: WARNING: Unreachable code after section jump
unreachable-children-warning.cuentitos:5: WARNING: Unreachable code after section jump
START
-> Section A
Text before
-> Section B
