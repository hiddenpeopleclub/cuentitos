...
## Result
```result
unreachable-siblings-warning.cuentitos:4: WARNING: Unreachable code after section jump
unreachable-siblings-warning.cuentitos:5: WARNING: Unreachable code after section jump
START
-> Section A
Text before
-> Section B
